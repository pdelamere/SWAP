...
;   arr(wh) = -bmx
   ...
   im = image(arr,/current,rgb_table=0,layout=[3,1,1],/buffer)
;   im = image(temparr,xarr,zarr,/current,rgb_table=33,layout=[3,1,1],/buffer)
   ...
   im1 = image(nparr,/current,rgb_table=0,layout=[3,1,2],/buffer)
   ...
   im2 = image(uparr,/current,rgb_table=0,layout=[3,1,3],/buffer)
